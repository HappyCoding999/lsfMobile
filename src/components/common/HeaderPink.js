...
export class HeaderPink extends Component {
  ...
  render() {
  const { onLeftPress,onRightPress, useGradient} = this.props;
  var colors = [colorNew.darkPink, colorNew.mediumPink];
  const buttonBackgroundColor = this.state.isRightButtonSelected ? colorNew.lightPink : 'transparent';
  
  const displayGradient = useGradient == null ? true : useGradient == false ? false : true 
  if (displayGradient == false) {
    colors = [colorNew.mediumPink, colorNew.mediumPink];
  }
  ...
  return(
      <View style={{width:"100%",height:"100%",justifyContent:"center",alignItems:"center"}}>
        <LinearGradient
          ...
          colors={colors}
          style={{width:"100%", height:100,justifyContent:"center",alignItems:"flex-end",backgroundColor:"#bdbdbd",flexDirection:"row"}}>
        ...
        <View style={{width:"100%",height:20,justifyContent:"center",alignItems:"center",backgroundColor: colorNew.mediumPink}}/>
      </View>
    )
  }
};
